...
var Graticule = (function() {
  ...
  _.prototype.decToLonSex = function(d) {
    ...
    _.prototype.onAdd = function() {
        ...
        this.getPanes().floatPane.appendChild(this.get('container')); // Panel on top of overlayLayer Layer
    ...
    _.prototype.draw = function() {
        ...
        (this.sex_ ? this.decToLonSex(lo) : lo.toFixed(gridPrecision(dLng)) +'E' )));
        }
        ...
        (this.sex_ ? this.decToLatSex(b) : b.toFixed(gridPrecision(dLat)) +'N' )));
        }
    };
